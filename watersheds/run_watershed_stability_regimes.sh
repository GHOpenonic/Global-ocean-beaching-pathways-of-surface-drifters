...
#SBATCH -w node4005
#SBATCH -N 1
#SBATCH --job-name=watershed_stability_3regime_200_upper_diag
...
python watershed_clustering_stability_regimes.py \
  ...
  --trajectory-history-weights "0.1,0.2" \
  ...
  --watershed-existence-jaccard-threshold 0.5 \
  --noise-grouped-threshold 0.3 \
  --min-consensus-cluster-size 25 \
  --min-consensus-existence-probability 0.5
